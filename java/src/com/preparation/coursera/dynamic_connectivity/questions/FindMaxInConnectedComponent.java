 ...
 * <p>
 * Hint: maintain an extra array to the weighted quick-union data structure that stores for each root 𝚒
 * the large element in the connected component containing 𝚒. This needs to be processed in union()
 */
public class FindMaxInConnectedComponent {
}
